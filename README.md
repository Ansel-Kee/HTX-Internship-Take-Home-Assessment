...
2. If it is valid, the image is instead saved, and the thumbnails are generated using the Pillow library, and the database is updated with the image's metadata in the images table, with an initial status of "processing"
